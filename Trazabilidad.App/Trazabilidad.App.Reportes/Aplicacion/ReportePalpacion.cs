...
{
    public class ReportePalpacion
    {
        public PdfDocument makeReport()
        {
            var Palpacion = Sanidad.Servicios.FactoriaServiciosLocales<Palpacion>.GetInstance().GetServicio().GetAll();
            ...
            SelectPdf.PdfTextElement title = new SelectPdf.PdfTextElement(70, 30, "Conteo General de Palpaciones", font);
            page.Add(title);
            ...
            foreach (var bovino in ganado)
            {
                ...
                foreach (var sanidad in Palpacion)
                {
            ...
            text.Text = "";
            text = new SelectPdf.PdfTextElement(50, row+80, "Total Palpaciones", subfont);
            page.Add(text);

            text = new SelectPdf.PdfTextElement(500, row+80, Palpacion.Count.ToString(), subfont);
            page.Add(text);
