...
{
    public partial class FormPreñado : Form
    {
        ...
        {
            FormPreñadoController.GetInstance().LoadFormSanidad(TipoSanidad, textBoxSanidadId, dateTPEntrada, richTextBoxObservaciones, comboBoxBovino);
        ...
        private void btnGuardar_Click(object sender, EventArgs e)
        {
            ...
            FormPreñadoController.GetInstance().Update(TipoSanidad, textBoxSanidadId, dateTPEntrada, richTextBoxObservaciones, comboBoxBovino);
